...
const stellentitel =
  "Auszubildende zur Zahnmedizinischen Fachangestellten (ZFA) (m/w/d)";
...
const zahlen = [
  ...
  { value: "8", label: "Menschen im Team" },
];
...
const stellenanzeige = {
  ...
  title: stellentitel,
  description: [
    `<p>Wir bilden zur ${ausbildung.beruf} aus. Ausbildungsbeginn ist der ${ausbildung.beginnLang}, die Ausbildung dauert ${ausbildung.dauerJahre} Jahre.</p>`,
    ...
    <>
      ...
      <div className="seitenkopf">
        ...
        <div>
          <p className="fliesstext fliesstext--gross">
            Wir bilden aus — zur Zahnmedizinischen Fachangestellten, Beginn am{" "}
            {ausbildung.beginnLang}. In einer Praxis, die seit 1991 in Familienhand ist, mit acht
            Leuten, fünf Behandlungszimmern und einem eigenen Zahnlabor eine Tür weiter. Du lernst
            den Beruf hier nicht in Ausschnitten, sondern ganz: vom Behandlungsstuhl über die
            Prophylaxe bis zum Empfang.
          </p>
      ...
      <figure
        ...
        <Bild
          ...
          src="/images/empfang-tresen-flur-zahnarztpraxis-potsdam.jpg"
          alt="Empfangstresen und Flur der Zahnarztpraxis Groß & Groß"
        />
        <figcaption
          style={{
            position: "absolute",
          ...
          Der Empfang · hier fängt fast jeder Tag an
        </figcaption>
      </figure>
      <div
        className="statbar"
      ...
      <div
        ...
        <div>
          ...
          <p
            ...
            In großen Zentren übernimmt jede Kraft ihren festen Ausschnitt. Bei uns geht das
            nicht — und das ist für die Ausbildung ein Vorteil: Du siehst den ganzen Weg eines
            Patienten, von der Begrüßung am Empfang bis zur fertigen Krone aus dem Labor.
          </p>
        </div>
      ...
      <div
        ...
        Höhe der Ausbildungsvergütung · zuständige Berufsschule · Ansprechpartnerin für
        Bewerbungen · ob ein Praktikum oder Schnuppertag möglich ist · Bewerbungsfrist (steht im
        JobPosting derzeit auf dem Tag vor Ausbildungsbeginn) · Instagram oder Facebook, falls
        vorhanden.
      </div>
      <div
        style={{
        ...
        <div>
          ...
          <p
            className="fliesstext"
            style={{ marginTop: "20px" }}>
            Schick uns deinen Lebenslauf und ein paar Sätze, warum dich der Beruf interessiert.
            Ein förmliches Anschreiben nach Vorlage brauchen wir nicht. Wenn du vorher etwas
            wissen willst, ruf an — das beantwortet meist mehr als jede Stellenanzeige. Wir melden
            uns {praxis.antwortzeit} zurück.
          </p>
        </div>
        <div>
          <p
      ...
      <div className="abschluss">
        <div className="ueberzeile ueberzeile--hell">
          Ausbildungsstart {ausbildung.beginnLang}
        </div>
